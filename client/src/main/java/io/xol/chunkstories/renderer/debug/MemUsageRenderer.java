...
public class MemUsageRenderer {
	...
	public static void draw(OpenGLRenderingContext renderingContext) {
		...
		overlayProgram.setUniform2f("screenSize", renderingContext.getWindow().getWidth(),
				renderingContext.getWindow().getHeight());
		...
		renderingContext.getFontRenderer().drawStringWithShadow(renderingContext.getFontRenderer().defaultFont(), 4,
				192 + 192 + 192 - 30, "Memory used (%" + Runtime.getRuntime().totalMemory() / 1024 / 1024 + "Mb)", 2, 2,
