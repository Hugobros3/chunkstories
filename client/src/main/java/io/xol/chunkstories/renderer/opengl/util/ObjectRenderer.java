...
public class ObjectRenderer
{
	...
	{
		Client.getInstance().getGameWindow().getRenderingInterface().getGuiRenderer().drawBoxWindowsSpace(xpos - w / 2, ypos + h / 2, xpos + w / 2, ypos - h / 2, 0, 0, 0, 0, null, false, true, new Vector4f(r, v, b, a));
	}
}
