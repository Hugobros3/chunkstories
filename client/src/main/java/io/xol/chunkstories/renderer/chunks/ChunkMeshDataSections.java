...
public class ChunkMeshDataSections {
	...
	/**
	 * Represents a Voxel that exposes a dynamic renderer and the indexes of the
	 * cells within a chunk that correspond to it
	 */
	...
	public ChunkMeshDataSections(RecyclableByteBuffer dataToUpload, int[][][] vertices_type_size,
			int[][][] vertices_type_offset) {
