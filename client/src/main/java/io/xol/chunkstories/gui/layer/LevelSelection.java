...
public class LevelSelection extends Layer {
	...
	public void render(RenderingInterface renderer) {
		...
		renderer.getFontRenderer().drawStringWithShadow(font, 64, posY + 64, "Select a level...", 3, 3,
				new Vector4f(1));
	...
	public class LocalWorldButton extends BaseButton {
		...
		public void render(RenderingInterface renderer) {
			...
			renderer.getGuiRenderer().drawCorneredBoxTiled(xPosition, yPosition, width, height * scale(), 8, texture,
					32, scale());
			...
			renderer.getFontRenderer().drawStringWithShadow(font, xPosition + 72, yPosition + 34,
					info.getName() + "#CCCCCC    Size : " + info.getSize().toString() + " ( "
							+ info.getSize().sizeInChunks / 32 + "x" + info.getSize().sizeInChunks / 32 + " km )",
					2, 2, width - 72, new Vector4f(1.0f));
			renderer.getFontRenderer().drawStringWithShadow(font, xPosition + 72, yPosition + 4, info.getDescription(),
					2, 2, -1, new Vector4f(1.0f));
