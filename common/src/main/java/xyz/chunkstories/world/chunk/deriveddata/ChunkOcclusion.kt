...
class ChunkOcclusionProperty(val chunk: ChunkImplementation) : AutoRebuildingProperty((chunk.world.gameInstance as Engine).tasks, false), ChunkOcclusionManager {
