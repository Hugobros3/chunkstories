...
/**
 * A queue that garantees uniqueness AND order while still being concurrent
 * access
 * 
 * @author Gobrosse
 *
...
public class UniqueQueue<T> implements Queue<T> {
	...
	public int size() {
		/*
		 * if(internalSet.size() != internalQueue.size()) { System.out.
		 * println("Critical error : UniqueQueue incoherence ( size differs between backing set and queue : "
		 * +internalSet.size()+" != "+ internalQueue.size()+")");
