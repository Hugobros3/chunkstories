...
public class ModelLibrary
{
	...
	//Map<Asset, ObjMeshRenderable> objModelsRenderable = new HashMap<Asset, ObjMeshRenderable>();
	//Map<Asset, ObjMeshComplete> objModelsComplete = new HashMap<Asset, ObjMeshComplete>();
	 ...
	 */
	/*public ObjMeshRenderable getRenderableMesh(String name)
	{
