...
/**
 * Hilariously ugly helper methods I wrote in 2014 for another, unrelated game
 * and kept using like the filthy degenerate that I am
 */
public class HttpRequests {
	public static String sendPost(String address, String params) {
		try {
			...
			System.out.println(
					"Coudln't perform POST request on " + address + ", (" + e.getMessage() + ") stack trace above :");
