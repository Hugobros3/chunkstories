...
public class FancyParser {
	public static Map<String, String> parseArguments(String[] args) {
		...
		while (completeArgumentsString.indexOf("-") != -1) {
			...
			while (completeArgumentsString.indexOf(" ") != -1
					&& completeArgumentsString.indexOf(" ") < completeArgumentsString.indexOf("-"))
			...
			if (completeArgumentsString.startsWith("-")) {
				...
				if (completeArgumentsString.contains("=")) {
					...
					if (completeArgumentsString.charAt(completeArgumentsString.indexOf('=') + 2) == '\"') {
						...
						int quotesEnd = completeArgumentsString.indexOf('\"',
								completeArgumentsString.indexOf('\"') + 1);
						str_end = quotesEnd;
					}

					String argumentString = completeArgumentsString.substring(completeArgumentsString.indexOf('-'),
							str_end);
