...
package io.xol.chunkstories.particle;
...
public class ParticleTypeDefinitionImplementation extends GenericNamedConfigurable implements ParticleTypeDefinition {
	...
	public ParticleTypeDefinitionImplementation(ParticlesTypesStore store, String particleName, BufferedReader reader)
